...
The User Admin Plugin is a lightweight API for providing user management functionality around Auth Repository APIs and enables remote programmatic access to manage your registered [User Auth Repository](/authentication-and-authorization#user-auth-repository), featuring:
